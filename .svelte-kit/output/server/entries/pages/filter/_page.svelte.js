import { c as pop, m as stringify, p as push } from "../../../chunks/index.js";
...
function _page($$payload, $$props) {
  ...
  $$payload.out += `<div class="mx-auto max-w-[800px] min-h-[425px]"><div class="mb-6">I've run the scribbles through an image model to get keywords, captions and styles. This what the search bar is hooked up to. It's pretty good for things like "still life" or "green". "Ball" will return both "ball" and "balloon".</div> <div class="mb-4 flex justify-center"><div class="relative w-full md:w-1/2"><input type="text"${attr("value", searchQuery)} placeholder="Search for something..." class="w-full px-4 py-2 rounded-none focus:outline-none focus:ring-2 bg-[#FADA7A] text-black placeholder-black"${attr("style", `border: 4px solid ${stringify(colours[i])};`)}> `;
  {
    $$payload.out += "<!--[!-->";
  }
  $$payload.out += `<!--]--></div></div> <!---->`;
