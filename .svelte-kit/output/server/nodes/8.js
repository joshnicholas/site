import * as universal from '../entries/pages/tinkering/colourmatch/_page.js';

export const index = 8;
let component_cache;
export const component = async () => component_cache ??= (await import('../entries/pages/tinkering/colourmatch/_page.svelte.js')).default;
export { universal };
export const universal_id = "src/routes/tinkering/colourmatch/+page.js";
...
export const stylesheets = ["_app/immutable/assets/8.gPmmZy0Y.css","_app/immutable/assets/postList.DjdvdsIi.css"];
export const fonts = [];
